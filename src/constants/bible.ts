// Números de libros de la Biblia según la tabla oficial de MyBible (RVR60)
export const BOOK_NUMBERS: { [key: string]: number } = {
  // Pentateuco
  ...
  'Esdras': 150, 'Nehemías': 160, 'Ester': 190,
  
  // Libros Poéticos
  'Job': 220, 'Salmos': 230, 'Proverbios': 240, 'Eclesiastés': 250, 'Cantares': 260,
  
  // Profetas Mayores
  'Isaías': 290, 'Jeremías': 300, 'Lamentaciones': 310, 'Ezequiel': 330, 'Daniel': 340,
  
  // Profetas Menores
  'Oseas': 350, 'Joel': 360, 'Amós': 370, 'Abdías': 380, 'Jonás': 390,
  'Miqueas': 400, 'Nahúm': 410, 'Habacuc': 420, 'Sofonías': 430, 'Hageo': 440,
  'Zacarías': 450, 'Malaquías': 460,
  
  // Nuevo Testamento
  'Mateo': 470, 'Marcos': 480, 'Lucas': 490, 'Juan': 500, 'Hechos': 510,
  
  // Epístolas de Pablo
  'Romanos': 520, '1 Corintios': 530, '2 Corintios': 540, 'Gálatas': 550, 'Efesios': 560,
  'Filipenses': 570, 'Colosenses': 580, '1 Tesalonicenses': 590, '2 Tesalonicenses': 600,
  '1 Timoteo': 610, '2 Timoteo': 620, 'Tito': 630, 'Filemón': 640, 'Hebreos': 650,
  
  // Epístolas Generales
  'Santiago': 660, '1 Pedro': 670, '2 Pedro': 680, '1 Juan': 690, '2 Juan': 700,
  '3 Juan': 710, 'Judas': 720, 'Apocalipsis': 730
};

// Nombres de libros por número según la tabla oficial de MyBible (RVR60)
export const BOOK_NAMES: { [key: number]: string } = {
  10: 'Génesis', 20: 'Éxodo', 30: 'Levítico', 40: 'Números', 50: 'Deuteronomio',
  60: 'Josué', 70: 'Jueces', 80: 'Rut', 90: '1 Samuel', 100: '2 Samuel',
  110: '1 Reyes', 120: '2 Reyes', 130: '1 Crónicas', 140: '2 Crónicas',
  150: 'Esdras', 160: 'Nehemías', 190: 'Ester', 220: 'Job', 230: 'Salmos',
  240: 'Proverbios', 250: 'Eclesiastés', 260: 'Cantares', 290: 'Isaías',
  300: 'Jeremías', 310: 'Lamentaciones', 330: 'Ezequiel', 340: 'Daniel',
  350: 'Oseas', 360: 'Joel', 370: 'Amós', 380: 'Abdías', 390: 'Jonás',
  400: 'Miqueas', 410: 'Nahúm', 420: 'Habacuc', 430: 'Sofonías', 440: 'Hageo',
  450: 'Zacarías', 460: 'Malaquías', 470: 'Mateo', 480: 'Marcos', 490: 'Lucas',
  500: 'Juan', 510: 'Hechos', 520: 'Romanos', 530: '1 Corintios', 540: '2 Corintios',
  550: 'Gálatas', 560: 'Efesios', 570: 'Filipenses', 580: 'Colosenses',
  590: '1 Tesalonicenses', 600: '2 Tesalonicenses', 610: '1 Timoteo', 620: '2 Timoteo',
  630: 'Tito', 640: 'Filemón', 650: 'Hebreos', 660: 'Santiago', 670: '1 Pedro',
  680: '2 Pedro', 690: '1 Juan', 700: '2 Juan', 710: '3 Juan', 720: 'Judas',
  730: 'Apocalipsis'
};

// Capítulos por libro
export const CHAPTERS_PER_BOOK: { [key: string]: number } = {
...
// Versículos por capítulo para todos los libros de la RVR60
export const VERSES_PER_CHAPTER: { [key: string]: { [key: number]: number } } = {
  'Génesis': {
  ...
  'Salmos': {
    ...
    101: 8, 102: 28, 103: 22, 104: 35, 105: 45, 106: 48, 107: 43, 108: 13, 109: 31,
    110: 7, 111: 10, 112: 10, 113: 9, 114: 8, 115: 18, 116: 19, 117: 2, 118: 29,
    119: 176, 120: 7, 121: 8, 122: 9, 123: 4, 124: 8, 125: 5, 126: 6, 127: 5, 128: 6,
    129: 8, 130: 8, 131: 3, 132: 18, 133: 3, 134: 3, 135: 21, 136: 26, 137: 9, 138: 8,
    139: 24, 140: 13, 141: 10, 142: 7, 143: 12, 144: 8, 145: 21, 146: 10, 147: 20,
    148: 14, 149: 9, 150: 6
  },
  'Proverbios': {
...
// Lista de libros organizados por testamento con números oficiales de MyBible (RVR60)
export const BIBLE_BOOKS = [
  // Antiguo Testamento
  { type: 'separator', label: '--- ANTIGUO TESTAMENTO ---' },
  { name: 'Génesis', number: 10 },
  { name: 'Éxodo', number: 20 },
  { name: 'Levítico', number: 30 },
  { name: 'Números', number: 40 },
  { name: 'Deuteronomio', number: 50 },
  { name: 'Josué', number: 60 },
  { name: 'Jueces', number: 70 },
  { name: 'Rut', number: 80 },
  { name: '1 Samuel', number: 90 },
  { name: '2 Samuel', number: 100 },
  { name: '1 Reyes', number: 110 },
  { name: '2 Reyes', number: 120 },
  { name: '1 Crónicas', number: 130 },
  { name: '2 Crónicas', number: 140 },
  { name: 'Esdras', number: 150 },
  { name: 'Nehemías', number: 160 },
  { name: 'Ester', number: 190 },
  { name: 'Job', number: 220 },
  { name: 'Salmos', number: 230 },
  { name: 'Proverbios', number: 240 },
  { name: 'Eclesiastés', number: 250 },
  { name: 'Cantares', number: 260 },
  { name: 'Isaías', number: 290 },
  { name: 'Jeremías', number: 300 },
  { name: 'Lamentaciones', number: 310 },
  { name: 'Ezequiel', number: 330 },
  { name: 'Daniel', number: 340 },
  { name: 'Oseas', number: 350 },
  { name: 'Joel', number: 360 },
  { name: 'Amós', number: 370 },
  { name: 'Abdías', number: 380 },
  { name: 'Jonás', number: 390 },
  { name: 'Miqueas', number: 400 },
  { name: 'Nahúm', number: 410 },
  { name: 'Habacuc', number: 420 },
  { name: 'Sofonías', number: 430 },
  { name: 'Hageo', number: 440 },
  { name: 'Zacarías', number: 450 },
  { name: 'Malaquías', number: 460 },
  // Nuevo Testamento
  { type: 'separator', label: '--- NUEVO TESTAMENTO ---' },
  { name: 'Mateo', number: 470 },
  { name: 'Marcos', number: 480 },
  { name: 'Lucas', number: 490 },
  { name: 'Juan', number: 500 },
  { name: 'Hechos', number: 510 },
  { name: 'Romanos', number: 520 },
  { name: '1 Corintios', number: 530 },
  { name: '2 Corintios', number: 540 },
  { name: 'Gálatas', number: 550 },
  { name: 'Efesios', number: 560 },
  { name: 'Filipenses', number: 570 },
  { name: 'Colosenses', number: 580 },
  { name: '1 Tesalonicenses', number: 590 },
  { name: '2 Tesalonicenses', number: 600 },
  { name: '1 Timoteo', number: 610 },
  { name: '2 Timoteo', number: 620 },
  { name: 'Tito', number: 630 },
  { name: 'Filemón', number: 640 },
  { name: 'Hebreos', number: 650 },
  { name: 'Santiago', number: 660 },
  { name: '1 Pedro', number: 670 },
  { name: '2 Pedro', number: 680 },
  { name: '1 Juan', number: 690 },
  { name: '2 Juan', number: 700 },
  { name: '3 Juan', number: 710 },
  { name: 'Judas', number: 720 },
  { name: 'Apocalipsis', number: 730 }
];

// Funciones de utilidad
export const getBookNumber = (bookName: string): number => {
  return BOOK_NUMBERS[bookName] || 10; // Génesis como valor por defecto
};

export const getBookName = (bookNumber: number): string => {
  return BOOK_NAMES[bookNumber] || 'Génesis';
};

export const getChaptersForBook = (bookName: string): number => {
  return CHAPTERS_PER_BOOK[bookName] || 1;
};

export const getVersesForChapter = (bookName: string, chapter: number): number => {
  const bookVerses = VERSES_PER_CHAPTER[bookName];
  if (bookVerses && bookVerses[chapter]) {
    return bookVerses[chapter];
  }
  // Valor por defecto más razonable basado en el promedio de versículos por capítulo
  // La mayoría de capítulos tienen entre 20-40 versículos
  return 30; // Valor por defecto si no hay datos específicos
}; 